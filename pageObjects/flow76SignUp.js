class flow76SignUp {
	...
	emailImput() {
		return cy
			...
			.type('andrej.milosavljevic+240519@sleepio.com');
	}
	passwordLabel() {
	...
	phoneImput() {
		return cy.xpath('/html/body/div[1]/div/div[3]/div/div/div[2]/div/form/div[4]/div/input').type('555-777');
	}

	passwordImput() {
		return cy.xpath('/html/body/div[1]/div/div[3]/div/div/div[2]/div/form/div[5]/div/input').type('Qwerty123');
	}
	passwordImput77() {
